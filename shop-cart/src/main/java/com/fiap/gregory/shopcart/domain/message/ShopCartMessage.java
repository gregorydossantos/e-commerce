...
public class ShopCartMessage {
    ...
    public static final String INVALID_PRICE = "Invalid price receive from request!";
    public static final String INVALID_AMOUNT = "Invalid amount receive from request!";
}
